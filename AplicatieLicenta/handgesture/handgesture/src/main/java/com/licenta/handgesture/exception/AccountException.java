...
/**
 * This class is used for handling custom exceptions specific to the Account
 */
@Getter
public class AccountException extends RuntimeException{
	...
	/**
	 * Constructs a new AccountExceptions with the specified detail message, HTTP status, and error code.
	 * 
	 * @param message the detail message of the error
	 * @param status the status of the HTTP response
	 * @param errorCode the internal error code
	 */
	public AccountException(Message message, HttpStatus status, InternalErrorCode errorCode) {
