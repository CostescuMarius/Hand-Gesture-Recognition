package com.licenta.handgesture.utility;
...
public class DateUtility {
	...
	/**
	 * Autowired configuration object to access application properties related to account settings.
	 */
	@Autowired
	...
	public int getDaysLeftForRecovery(User user) {
		...
		int daysLeft = accountProperties.getDaysUntilDeletion() - daysSinceDeletion;
	...
	public int getDaysLeftForConfirmAccount(User user) {
		...
		int daysLeft = accountProperties.getDaysForEmailConfirmation() - daysSinceCreation;
